...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'filtered_kitti_infos_train_lite.pkl',
            split='training',
            pts_prefix='filtered_velodyne',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'filtered_kitti_infos_val_good.pkl',
        split='training',
        pts_prefix='filtered_velodyne',
...
work_dir = '/media/ntu/volume1/home/s122md304_13/quan_fyp/train_kitti/votr_car_filtered'
...
load_from = "/media/ntu/volume1/home/s122md304_13/quan_fyp/train_kitti/votr_car/epoch_92.pth"